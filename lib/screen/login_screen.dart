...
// Definición de un widget sin estado (StatelessWidget) para la pantalla de inicio de sesión.
class LoginScreen extends StatelessWidget {
  const LoginScreen({super.key});
    // Método build que construye la interfaz de usuario para la pantalla de inicio de sesión.
  @override
...
// Definición de un widget sin estado (StatelessWidget) para el formulario de inicio de sesión.
